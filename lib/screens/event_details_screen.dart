...
class _EventDetailsScreenState extends State<EventDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // ─── CABECERA PREMIUM MEJORADA (EVITA EL EFECTO VACÍO) ───
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: Colors.black.withValues(alpha: 0.1), // Usa esto en lugar de black10 para evitar conflictos con const
                  blurRadius: 6, 
          ...
          // ─── BOTÓN DE ACCIÓN MODIFICADO SEGÚN EL ROL ───
          Padding(
            ...
            child: Consumer<EventProvider>(
              builder: (context, provider, child) {
                ...
                if (provider.isActionLoading) {
                  ...
                  // Acción de negocio para el creador
          ...
          // ─── SECCIÓN HORIZONTAL DE PARTICIPANTES ───
          ...
          // ─── CHAT PROTEGIDO (VALIDACIÓN DE SEGURIDAD EN UI) ───
          Expanded(
